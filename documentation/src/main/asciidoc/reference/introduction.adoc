...
IMPORTANT: If you can't identify a natural key, it's _highly likely_
that you have not thought hard enough about your data model, or that
there's something actually wrong with your model. If your entity doesn't
have a unique key, then it's impossible to say what event or object it
represents in the "real world" outside your program.
